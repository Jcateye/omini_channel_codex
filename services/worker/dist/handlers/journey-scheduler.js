    ...
    const tick = async () => {
        ...
        try {
            ...
            for (const trigger of triggers) {
                const config = trigger.config && typeof trigger.config === 'object' && !Array.isArray(trigger.config)
                    ? trigger.config
                    : {};
                ...
                const leads = leadId
                    ...
                    : await prisma.lead.findMany({
                        where: buildLeadWhere(trigger.organizationId, {
                            ...
                            lastActiveWithinDays: typeof config.lastActiveWithinDays === 'number'
...
//# sourceMappingURL=journey-scheduler.js.map