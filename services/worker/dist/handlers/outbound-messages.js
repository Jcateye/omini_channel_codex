...
const resolveRecipient = (content, contact) => {
...
const mergeCancelPayload = (rawPayload) => {
...
export const registerOutboundMessagesWorker = () => createWorker(QUEUE_NAMES.outboundMessages, async (job) => {
    ...
    try {
        const result = await adapter.sendText({
            ...
            channel: {
                ...
                credentials: message.channel.credentials,
                settings: message.channel.settings && typeof message.channel.settings === 'object'
                    ? message.channel.settings
                    : null,
                metadata: message.channel.metadata && typeof message.channel.metadata === 'object'
...
//# sourceMappingURL=outbound-messages.js.map